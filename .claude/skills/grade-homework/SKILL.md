...
5. Run a **second-pass** review for every low-confidence item, unreadable region,
   total mismatch, and high-impact deduction. The second pass must revisit the
   source image and evidence, not merely repeat the first score.
...
lowest-agreement Physics Week 9 questions; do not generalize those error patterns
